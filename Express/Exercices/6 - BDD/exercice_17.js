...
*********************************/
/*
Il est préférable de se connecter à chaque fois qu'une route est gérée et de se déconnecter à la fin de celle-ci. Cela permet de s'assurer que le serveur est toujours disponible.
...
/* Dans le fichier index.js où nous gérons les différentes routes, nous faisons un require du fichier db.js.
...
app.get('/', (req, res) => {
  db.connect('localhost:27017', function(err){
